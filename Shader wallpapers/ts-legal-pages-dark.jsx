      ...
      <div style={{ position: 'absolute', inset: 0, zIndex: 2, overflowY: 'auto', paddingBottom: 32 }}>
        ...
        <div style={{ padding: '24px 18px 0' }}>
          <div style={{
            ...
            background: 'linear-gradient(135deg, rgba(60,60,68,0.22), rgba(255,177,200,0.10))',
            border: '0.5px solid rgba(255,255,255,0.12)',
            backdropFilter: 'blur(14px) saturate(160%)', WebkitBackdropFilter: 'blur(14px) saturate(160%)',
              ...
              {sections[active].bullets.map((b, j) => (
                <div key={j} style={{
                  ...
                  <div style={{
                    ...
                    background: 'linear-gradient(180deg, #FFB1C8, #525258)',
                  }}/>
