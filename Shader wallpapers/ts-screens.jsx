      ...
      <div style={{ padding: '0 18px 14px' }}>
        ...
        <div style={{
          ...
          Tonight's a <span style={{
            background: 'linear-gradient(90deg, #FFE0FF, #B57BE8)',
              ...
              <div key={r.label} style={{ marginBottom: 7 }}>
                ...
                <div style={{ height: 3, marginTop: 3, background: 'rgba(255,255,255,0.08)', borderRadius: 2, overflow: 'hidden' }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(90deg, #B57BE8, #FFB1C8)',
                  }}/>
                </div>
              </div>
            ))}
    ...
    <svg width="112" height="112" viewBox="0 0 112 112">
      ...
      <defs>
        <linearGradient id="r-fill" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#B57BE8" stopOpacity="0.7"/>
...
function QuickView(){
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', background: '#0A0418' }}>
      <MeshBg seed={4}/>
      {/* dimmed home behind */}
      <div style={{ position: 'absolute', inset: 0, zIndex: 1, background: 'rgba(8,4,20,0.55)', backdropFilter: 'blur(6px)' }}/>
    ...
    <svg viewBox="0 0 320 160" style={{ width: '100%', display: 'block' }}>
      <defs>
        <radialGradient id="stagev" cx="50%" cy="100%" r="60%">
          ...
          <stop offset="100%" stopColor="#B57BE8" stopOpacity="0"/>
        </radialGradient>
      </defs>
      {/* stage */}
