      ...
      <div style={{ position: 'absolute', inset: 0, zIndex: 2, overflowY: 'auto', paddingBottom: 32 }}>
        ...
        <div style={{ padding: '28px 22px 0' }}>
          ...
          <div style={{ marginTop: 14, display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
            {[['Dani','Founder','#FFB1C8'],['Luca','Eng','#D4A8F0'],['Mara','Design','#7C5BC4']].map(([n, r, c]) => (
              <div key={n} style={{
                ...
                <div style={{ width: 48, height: 48, borderRadius: 99, margin: '0 auto', background: `linear-gradient(135deg, ${c}, #5B3FA8)`, display: 'grid', placeItems: 'center', color: '#fff', fontFamily: '"Space Grotesk", system-ui', fontSize: 17, fontWeight: 700, border: '1.5px solid rgba(255,255,255,0.2)' }}>{n[0]}</div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        display: 'grid', placeItems: 'center', color: '#E0C0FF',
        flexShrink: 0,
      }}>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{
          ...
          background: 'linear-gradient(135deg, #FFB1C8, #D4A8F0, #7C5BC4)',
