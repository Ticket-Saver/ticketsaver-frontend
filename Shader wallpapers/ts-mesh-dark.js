// ts-mesh-dark.js — Grayscale charcoal mesh background
// Drop-in replacement for ts-mesh.js (same API: window.TSMesh)
...
void main(){
  ...
  // Charcoal palette — six values from near-black to soft graphite,
  // with one whisper of warmth so it doesn't read as flat gray.
  const PALETTE_DEFAULT = [
    hex('#0A0A0C'), // base — almost black
    hex('#15151A'), // deeper shadow corner
    hex('#3A3A42'), // brightest highlight (still very dim)
    hex('#1E1E22'), // shadow mid
    hex('#26262C'), // mid tone
    hex('#2E2E36'), // warm gray hint
  ];
