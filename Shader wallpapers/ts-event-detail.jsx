  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', background: '#0A0418' }}>
        ...
        <div style={{ padding: '18px 18px 0' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
            <div style={{ minWidth: 0, flex: 1 }}>
              <div style={{ fontSize: 10.5, color: '#E0C0FF', letterSpacing: '0.16em', textTransform: 'uppercase', fontWeight: 600 }}>{base.category} · Tour</div>
              <div style={{
      ...
      <div style={{
        ...
        background: 'linear-gradient(to top, rgba(10,4,24,0.95) 60%, rgba(10,4,24,0))',
      }}>
        <button style={{
  ...
  return (
    <div style={{ position: 'relative', height: 320, width: '100%' }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(to top, rgba(10,4,24,1) 0%, rgba(10,4,24,0.5) 50%, transparent 100%)',
      }}/>
  ...
  return (
    <div onClick={onClick} style={{
      ...
      <div style={{
        ...
        color: active ? '#3D2566' : 'rgba(255,255,255,0.65)',
      ...
      <div style={{
        ...
        borderTop: '0.5px solid ' + (active ? 'rgba(26,15,51,0.10)' : 'rgba(255,255,255,0.08)'),
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
      }}>
        <div style={{
          fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase',
          color: active ? '#7B3FE4' : '#D4A8F0',
        }}>{date.status}</div>
