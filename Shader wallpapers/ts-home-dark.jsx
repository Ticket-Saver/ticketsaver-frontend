    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{
          ...
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M3 4 L7 2 L11 4 L11 10 L7 12 L3 10 Z" stroke="#0F0F12" strokeWidth="1.4" strokeLinejoin="round"/>
            <circle cx="7" cy="7" r="1.4" fill="#0F0F12"/>
          </svg>
        </div>
        <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ position: 'relative' }}>
          ...
          {cartCount > 0 && (
            <div style={{
              ...
              borderRadius: 10,
              background: `linear-gradient(135deg, #FF5E9E, #9090A0)`,
        ...
        <div style={{
          ...
          cursor: 'pointer',
          boxShadow: '0 4px 12px rgba(60,60,68,0.4)',
        }}>DP</div>
      </div>
    </div>
  );
    ...
    <div style={{ padding: '0 18px' }}>
      <div style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(to top, rgba(8,8,10,0.92) 0%, rgba(8,8,10,0.5) 50%, transparent 100%)',
        }}/>
        ...
        <div style={{ position: 'absolute', left: 16, right: 16, bottom: 14, color: '#fff' }}>
          <div style={{
            ...
            <div style={{ width: 5, height: 5, borderRadius: 3, background: '#E5E5EA', boxShadow: '0 0 8px #E5E5EA' }}/>
    ...
    <div style={{
      ...
      {cats.map(c => (
        <div key={c} style={{
          ...
          color: c === active ? '#141416' : 'rgba(255,255,255,0.85)',
