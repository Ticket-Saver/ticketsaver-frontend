      ...
      <div className='container mx-auto px-4 py-10'>
        ...
        <div className="pl-5">
          ...
          <div className="flex space-x-1">
            ...
            <p className='text-lg mb-4'>
              (You can text this number with your concern and email. We
              can get back to you faster)
            </p>
          </div>
        </div>
        ...
        <div className="pl-5">
          <div className="flex space-x-1">
            ...
            <a href='mailto:ticketing@ticketsaver.net' className='text-blue-500 hover:underline text-xl'>
