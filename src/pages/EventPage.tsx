      ...
      <div className='w-3/4 mx-auto py-10 sm:px-2 lg:px-20'>
        ...
        <div className='prose lg:prose-xl text-black w-full'>
          ...
          <p className='text-left'>
            ¡Llega por primera vez a New Jersey la comediante femenina #1 de América Latina!! ¡La
            India Yuridia! No te pierdas su nueva gira “Por que Asi Soy” donde te garantizamos
            pasaras una noche de risas junto a toda tu familia! ¡Compra tus boletos antes de que se
            agoten!
          </p>
        </div>
