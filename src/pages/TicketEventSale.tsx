                      ...
                      <>
                        ...
                        <div className="items-center flex justify-center">
                          <InteractiveMap
                            ...
                            getDefaultMap={label === 'las_leonas.03' ? CalifoniaTheatreMap : label === 'las_leonas.02' ? Unioncountry : undefined}
                            width={
                              windowSize < 768
                                ? (windowSize * 7) / 8
                                : windowSize / 2
                            }
                            src={label === 'las_leonas.03' ? californiaTheatreSvg : label === 'las_leonas.02' ? unionCountySvg : undefined}
                          />
                        </div>
                      </>
                    }
