...
export function EventCard({ title, city, date, description, thumbnailURL, color='bg-neutral', fontColor='text-neutral-content', venue}: EventCardConfig) {
  return (
    <div className={`card ${color} ${fontColor} shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-lg cursor-pointer w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl mx-auto`}>
      ...
      <div className="card-body px-4 py-6">
        ...
        <h1 className="inline-block text-sm sm:text-base">
          {city}
        </h1>
