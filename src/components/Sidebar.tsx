    ...
    return (
        <div className="bg-[#180F3C] bg-opacity-4 text-white w-80 min-h-screen p-4">
            <div className="flex flex-col items-center py-8">
                <img src={isAuthenticated && user?.picture ? user?.picture : '/user.png'} alt="Profile" className="w-40 h-40 rounded-full mb-4" />
                <h2 className="text-md mb-4">{user?.name}</h2>
            </div>
            <nav className="flex flex-col space-y-5 px-4">
                <Link to="#!" className="p-2 px-5 rounded-xl flex items-center bg-[#1A0F40] text-white hover:bg-[#221551] focus:bg-[#221551]">
                    <img src={TicketIcon} alt="Ticket Icon" className="h-6 w-6 text-white mr-2" />
                    My Tickets
                </Link>
                <Link to="#!" className="p-2 px-5 rounded-xl flex items-center text-white bg-[#1A0F40] hover:bg-[#221551] focus:bg-[#221551]">
