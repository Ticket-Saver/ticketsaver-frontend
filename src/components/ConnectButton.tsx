...
export function ConnectWalletButton() {
  ...
  return (
    <div className="flex flex-col items-center p-5 bg-transparent rounded-lg shadow-none w-full max-w-md mx-auto text-white">
      <button className={`mt-4 py-3 px-8 text-lg font-bold border-none rounded-lg cursor-pointer transition duration-300 transform ${showConnectOptions ? 'bg-gray-500 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-400 hover:scale-105'}`} onClick={handleButtonClick}>
