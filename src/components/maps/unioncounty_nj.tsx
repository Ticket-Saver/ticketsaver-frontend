  ...
  areas: [
    {
      ...
      fillColor: "#eab54d4d",
      strokeColor: "#f54242",
      coords: [257.7,314.3,257.3,331.0,217.3,330.7,217.7,348.3,198.3,349.0,197.7,367.7,159.7,366.7,158.3,402.0,417.7,402.0,417.3,313.0],
      polygon: [
        [257.7,314.3],
        [257.3,331.0],
        [217.3,330.7],
    ...
    },
    {
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords:[892.7,316.7,892.7,401.3,1164.0,400.7,1161.3,368.7,1123.3,367.3,1123.3,351.3,1082.0,348.7,1082.0,329.3,1062.0,330.7,1063.3,313.3],
        polygon: [
          [892.7,316.7],
          [892.7,401.3],
          [1164.0,400.7],
...
// Logue //7//////////////
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [43.7,650.7,45.0,668.7,64.3,669.0,65.0,712.3,44.3,712.7,44.3,775.7,140.0,775.7,139.0,651.0],
        polygon: [
          [43.7,650.7],
          [45.0,668.7],
          [64.3,669.0],
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [159.7,649.0,158.0,800.3,417.7,801.0,417.7,649.7,357.3,650.3,357.3,734.0,238.3,734.0,238.7,650.0],
        polygon: [
          [159.7,649.0],
          [158.0,800.3],
          [417.7,801.0],
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords:[444.7,650.3,443.3,801.3,534.0,800.7,532.3,756.0,750.0,756.7,750.3,800.7,842.0,800.7,839.7,649.3],
        polygon: [
          [444.7,650.3],
          [443.3,801.3],
          [534.0,800.7],
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [891.7,651.0,893.0,801.7,1163.0,801.3,1162.7,649.7,1082.0,650.0,1081.3,734.7,962.3,736.0,962.3,650.3],
        polygon: [
          [891.7,651.0],
          [893.0,801.7],
          [1163.0,801.3],
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [1191.0,650.3,1191.3,777.3,1292.3,778.0,1291.3,712.7,1269.7,712.0,1270.3,669.0,1290.7,668.0,1290.0,651.3],
        polygon: [
          [1191.0,650.3],
          [1191.3,777.3],
          [1292.3,778.0],
...

      {
        Options: {
          ...
          map: {
            ...
            indexerRows: {
              visible: true,
              label: (row: number) => `${String.fromCharCode(68 + row)}${String.fromCharCode(68 + row)}`,
            },
            seatTypes: {
              default: {
                label: "Gray",
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [1231.0,957.0,1229.0,1057.0,1310.7,1056.0,1311.0,1023.3,1290.7,1023.7,1289.7,957.7],
        polygon: [
          [1231.0,957.0],
          [1229.0,1057.0],
          [1310.7,1056.0],
