...
const getDefaultMap = () => ({
  ...
  areas: [
    ...
    },
    {
      ...
      strokeColor: '#f54242',
      coords: [
        540.5, 475.34, 673, 465.24, 805.5, 475.34, 810.3, 552.74, 673, 539.74, 533.7, 552.74
      ],
      polygon: [
        [540.5, 475.34],
        [673, 465.24],
    ...
    },
    {
      ...
      strokeColor: '#f54242',
      coords: [
        476.5, 686.5, 483.0, 706.0, 468.0, 710.5, 473.5, 734.5, 458.0, 736.0, 459.0, 754.5, 467.0,
        755.5, 470.5, 781.5, 457.5, 787.0, 460.5, 804.5, 466.5, 803.0, 471.0, 830.0, 456.0, 836.0,
        463.5, 855.5, 525.0, 844.5, 591.0, 835.5, 693.0, 833.0, 739.5, 833.0, 838.5, 849.5, 842.5,
        828.0, 867.5, 833.5, 877.5, 788.5, 866.0, 785.5, 877.5, 741.5, 865.5, 737.0, 870.5, 711.0,
        854.0, 710.5, 858.5, 683.0, 750.0, 663.5, 593.5, 665.0
      ],
      polygon: [
        [476.5, 686.5],
        [483.0, 706.0],
    ...
    },
    {
      ...
      strokeColor: '#f54242',
      coords: [
        465.0, 858.3, 487.3, 927.7, 552.3, 914.7, 586.0, 910.7, 617.7, 906.3, 716.0, 905.3, 753.0,
        905.3, 784.3, 909.3, 848.3, 920.7, 866.7, 859.0, 801.7, 843.7, 752.0, 836.7, 685.3, 834.3,
        600.7, 837.7
      ],
      polygon: [
        [465.0, 858.3],
    ...
    },
    {
      ...
      strokeColor: '#f54242',
      coords: [
        902.3, 791.0, 900.0, 934.0, 1012.7, 964.7, 1019.7, 943.7, 1027.7, 947.3, 1033.7, 934.0,
        1033.7, 828.3
      ],
      polygon: [
        [902.3, 791.0],
    ...
    },
    {
      ...
      strokeColor: '#f54242',
      coords: [
        484.17, 986.09, 588.95, 972.19, 588.95, 950.64, 751.7, 950.64, 751.7, 972.19, 857.86,
        986.09, 778.17, 1200.9, 566.79, 1200.9
      ],
      polygon: [
        [484.17, 986.09],
        [588.95, 972.19],
