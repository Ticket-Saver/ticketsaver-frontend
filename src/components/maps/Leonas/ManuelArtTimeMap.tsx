  ...
  areas: [
    {
      Options: {
        ...
        map: {
          ...
          indexerRows: {
            visible: true,
            label: (row: number) => `${String.fromCharCode(72 - row)}${String.fromCharCode(72 - row)}`,
          },
          seatTypes: {
            default: {
              label: "Green",
      ...
      fillColor: "#eab54d4d",
      strokeColor: "#f54242",
      coords: [34.7,12.0,34.7,43.3,88.0,42.7,90.0,199.3,236.7,200.0,236.7,86.0,309.3,87.3,311.3,11.3],
      polygon: [
        [34.7,12.0],
        [34.7,43.3],
        [88.0,42.7],
    ...
    },
    {
        Options: {
          ...
          map: {
            ...
            indexerRows: {
              visible: true,
              label: (row: number) => `${String.fromCharCode(71 - row)}${String.fromCharCode(71 - row)}`,
            },
            seatTypes: {
              default: {
                label: "Green",
...

      {
        Options: {
          ...
          map: {
            ...
            indexerRows: {
              visible: true,
              label: (row: number) => `${String.fromCharCode(70 - row)}${String.fromCharCode(70 - row)}`,
            },
            seatTypes: {
              default: {
                label: "Green",
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [534.0,89.0,531.5,161.5,563.0,161.5,564.5,198.5,780.0,198.5,780.0,162.0,808.0,161.0,808.5,89.0],
        polygon:[
          [534.0,89.0],
          [531.5,161.5],
          [563.0,161.5],
      ...
      },
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [1034.5,48.0,1033.0,83.0,1118.5,84.0,1115.0,200.0,1251.5,202.0,1252.5,47.5],
        polygon: [
          [1034.5,48.0],
          [1033.0,83.0],
          [1118.5,84.0],
      ...
      // ///////////////// Balcony next section
      {
        Options: {
          ...
          map: {
            ...
            indexerRows: {
              visible: true,
              label: (row: number) => `${String.fromCharCode(67 - row)}${String.fromCharCode(67 - row)}`,
            },
            seatTypes: {
              default: {
                label: "Blue",
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [94.0,394.5,55.0,452.0,44.5,521.5,43.5,806.0,178.5,806.0,176.0,515.5,183.5,481.5,142.0,471.5,147.0,456.5,107.0,443.5,122.5,417.0],
        polygon: [
          [94.0,394.5],
          [55.0,452.0],
          [44.5,521.5],
      ...
      // Orange section
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [115.7,356.7,174.7,414.0,218.3,373.0,277.0,347.3,334.7,343.7,429.0,345.0,430.7,265.0,289.7,264.3,199.0,290.0,144.3,325.3],
        polygon: [
          [115.7,356.7],
          [174.7,414.0],
          [218.3,373.0],
      ...
      // parte azul de la seccion 8
      {
        Options: {
          ...
          map: {
            ...
            indexerRows: {
              visible: true,
              label: (row: number) => `${String.fromCharCode(65)}${String.fromCharCode(65)}`,
            },
            seatTypes: {
              default: {
                label: "Blue",
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [182.0,418.0,207.0,446.0,233.0,416.5,281.0,393.0,315.5,387.6,431.0,386.5,430.0,354.0,303.5,354.5,271.0,361.5,234.5,376.0,209.0,391.0],
        polygon: [
          [182.0,418.0],
          [207.0,446.0],
          [233.0,416.5],
      ...
      //Zona 10 Orange
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [891.5,264.5,892.2,346.0,1011.0,346.5,1051.0,350.5,1090.5,366.5,1152.5,417.5,1213.0,360.5,1136.5,291.0,1072.5,270.5,996.5,263.0],
        polygon: [
          [891.5,264.5],
          [892.2,346.0],
          [1011.0,346.5],
        ...
        // Zona Azul
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [892.0,356.3,892.3,391.3,1012.0,391.0,1048.3,398.3,1082.0,414.7,1113.7,448.3,1143.3,422.7,1097.3,380.0,1059.3,361.0,1007.0,354.0],
        polygon: [
          [892.0,356.3],
          [892.3,391.3],
          [1012.0,391.0],
      ...
      // parte derecha
      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [1140.7,480.7,1144.7,514.0,1142.7,796.0,1274.0,796.7,1273.3,510.7,1263.3,443.3,1251.3,406.7,1208.0,425.3,1216.0,445.3,1172.7,456.0,1176.7,471.3],
        polygon: [
          [1140.7,480.7],
          [1144.7,514.0],
          [1142.7,796.0],
...

      {
        ...
        fillColor: "#eab54d4d",
        strokeColor: "#f54242",
        coords: [1061.3,549.3,1052.0,584.7,890.0,558.0,890.7,734.7,1120.0,768.7,1120.0,566.0],
        polygon: [
          [1061.3,549.3],
          [1052.0,584.7],
          [890.0,558.0],
