...
const getDefaultMap = () => ({
  ...
  areas: [
    ...
    // CENTER LEFT - ORANGE
    {
      ...
      strokeColor: "#eab54d4d",
      coords: [
        470, 232, 436, 305, 411, 409, 488, 429, 562, 438, 567, 347, 580, 257,
      ],
      polygon: [
        [470, 232],
        [436, 305],
    ...
    // CENTER CENTER - ORANGE
    {
      ...
      strokeColor: "#eab54d4d",
      coords: [
        596, 257, 590, 345, 592, 441, 678, 445, 761, 440, 763, 345, 754, 256,
        673, 262,
      ],
      polygon: [
        [596, 257],
    ...
    // CENTER RIGHT - ORANGE
    {
      ...
      strokeColor: "#eab54d4d",
      coords: [
        770, 253, 782, 345, 787, 438, 875, 425, 937, 407, 915, 318, 880, 235,
      ],
      polygon: [
        [770, 253],
        [782, 345],
    ...
    // GREEN TOP LEFT
    {
      ...
      strokeColor: "#eab54d4d",
      coords: [
        375, 208, 321, 282, 283, 361, 266, 415, 328, 440, 380, 456, 388, 398,
        411, 311, 446, 231,
      ],
      polygon: [
        [375, 208],
    ...
    // GREEN CENTER UP LEFT
    {
      ...
      strokeColor: "#eab54d4d",
      coords: [
        411, 411, 404, 466, 402, 562, 492, 578, 562, 587, 563, 496, 563, 441,
      ],
      polygon: [
        [411, 411],
        [404, 466],
    ...
    //  YELLOW DOWN RIGHT
    {
      Options: {
        ...
        map: {
          ...
          indexerRows: {
            visible: true,
            label: (row: number) =>
              `${String.fromCharCode(65 + row)}${String.fromCharCode(
                65 + row
              )}`,
          },
          seatTypes: {
      ...
      strokeColor: "#f54242",
      coords: [
        960, 866, 960, 1114, 1061, 1100, 1058, 1070, 1075, 1062, 1075, 1036,
        1091, 1027, 1090, 832,
      ],
      polygon: [
        [960, 866],
    ...
    //  YELLOW DOWN LEFT
    {
      ...
      id: "29",
      title: "Yellow Bottom Left 2",
      shape: "poly",
      name: "Yellow",
      fillColor: "#eab54d4d",
      strokeColor: "#eab54d4d",
      coords: [
        251, 831, 249, 1023, 266, 1034, 269, 1063, 277, 1066, 278, 1097, 378,
        1116, 379, 866,
      ],
      polygon: [
        [251, 831],
      ...
      Options: {
        ...
        map: {
          ...
          indexerRows: {
            visible: true,
            label: (row: number) =>
              `${String.fromCharCode(70 + row)}${String.fromCharCode(
                70 + row
              )}`,
          },
          seatTypes: {
    ...
    //  YELLOW DOWN CENTER BACK
    {
      Options: {
        ...
        cart: { visible: false },
        map: {
          seatLabel: (index: SeatIndex) => `${String.fromCharCode(70 + index.row)}${String.fromCharCode(70 + index.row)}${index.col + 1}`,
          rows: 3,
          columns: 13,
          indexerColumns: {
            visible: true,
