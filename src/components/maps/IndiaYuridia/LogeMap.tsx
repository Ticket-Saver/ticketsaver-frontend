const getDefaultMap = ()=>({
    ...
    areas: [
...

      {
        ...
        strokeColor: "#eab54d4d",
        coords: [
          1004, 468, 1003, 645, 1133, 609, 1137, 531, 1127, 546, 1125, 434,
        ],
        polygon: [
          [1004, 468],
          [1003, 645],
...

      {
        ...
        strokeColor: "#eab54d4d",
        coords: [
          150, 899, 147, 1012, 323, 1043, 323, 1007, 307, 1001, 307, 937,
        ],
        polygon: [
          [150, 899],
          [147, 1012],
...

      {
        ...
        strokeColor: "#eab54d4d",
        coords: [
          339, 937, 338, 1007, 328, 1009, 325, 1041, 530, 1073, 524, 964,
        ],
        polygon: [
          [339, 937],
          [338, 1007],
...

      {
        ...
        strokeColor: "#eab54d4d",
        coords: [
          862, 915, 862, 1064, 985, 1045, 987, 1009, 977, 1008, 974, 902,
        ],
        polygon: [
          [862, 915],
          [862, 1064],
...

      {
        ...
        strokeColor: "#eab54d4d",
        coords: [
          1007, 941, 1009, 1004, 991, 1010, 988, 1044, 1165, 1014, 1165, 899,
        ],
        polygon: [
          [1007, 941],
          [1009, 1004],
